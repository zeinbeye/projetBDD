...
<div class="corp2">
<center><h1>Liste des bus</h1></center>
<center><table  border="1" id="rounded-corner"  width=400px>
<thead><tr><?php //echo Edition();?>
 <th scope="col"  align="left" > Matricul de bus</th>
 <th scope="col" class="rounded-q2" align="left">Marque</th>
  <th scope="col" class="rounded-q2" align="left">Chauffeur</th>
...
{
// print_r( $row);
echo '<tr><td>'.$row['MATRICULE'].'</td><td>'.$row['MARQUE'].'</td><td>'.$row['NOM_CHAUFF'].'</td></tr>';
}
?>
